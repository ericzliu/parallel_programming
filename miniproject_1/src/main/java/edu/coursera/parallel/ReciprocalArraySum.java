...
public final class ReciprocalArraySum {
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i < numTasks; i++) {
            final int startInclusive = getChunkStartInclusive(i, numTasks, input.length);
            final int endExclusive = getChunkEndExclusive(i, numTasks, input.length);
            tasks.add(new ReciprocalArraySumTask(startInclusive, endExclusive, input));
        }
